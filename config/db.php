...
{
    private $db;
    private $hostname = 'mysql'; //ชื่อ Host
    private $username = 'root'; //ชื่อผู้ใช้งาน ฐานข้อมูล
    private $password = 'Mac++18'; // password สำหรับเข้าจัดการฐานข้อมูล
    private $database = 'coop_bru'; //ชื่อ ฐานข้อมูล
