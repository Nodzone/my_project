      ...
      <div>
        ...
        <form name="register" action="./FPDF/bru_co1.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label>** เวลาฝึกงาน (Time For Intership)</label>
          ...
          <div class="form-group">
            <label id="important">** ชื่อสถานปฏิบัติงานที่ต้องการสมัคร (Name of Company): </label>
            <input type="text" name="company_name" placeholder="ชื่อหน่วยงาน/องกรค์" required>
          </div>
          <div class="form-group">
            <label>** สมัครงานในตำแหน่ง (Position Sought) :</label>
          ...
          <div class="form-group">
            <label>** ชื่อ-สกุล (First Name-Last Name) :</label>
          ...
          <div class="form-group">
            <label>** รหัสนักศึกษา (Student identification No.) :</label>
          ...
          <div class="form-group">
            <label for="">** นักศึกษาชั้นปีที่ (Year in Department) :</label>
          ...
          <div class="form-group">
            <label for="">** อาจารย์ที่ปรึกษา (Name of Academic Advisor) :</label>
            <input type="text" name="teac_name" placeholder="ชื่ออาจารย์ที่ปรึกษา" data-required style="width:300px;">
          </div>
          <div class="form-group">
            <label for="">** เกรดเฉลี่ยภาคการศึกษาที่ผ่านมา (GPA for most Recently Completed Semester Year) :</label>
            <input type="text" name="gpa" required placeholder="เกรดเฉลี่ยภาคการศึกษาที่ผ่านมา">
          </div>
          <div class="form-group">
            <label for="">** เกรดเฉลี่ยรวม (GPAX for all Courses Completed to Date) : </label>
            <input type="text" name="gpax" required placeholder="เกรดเฉลี่ยรวม">
          </div>
          <div class="form-group">
            <label for="">** บัตรประจำตัวประชาชนเลขที่ (ID CARD NUMBER):</label>
            <input type="text" name="id_card" placeholder="เลขบัตรประชาขน" required maxlength="13">
          </div>
          <div class="form-group">
            <label for="">** ออกให้ ณ. (Issue at): </label>
            <input type="text" name="isa" placeholder=" เช่นทีว่าการอำเภอ เมือง ">

          </div>
          <div class="form-group">
            <label for="">** เมื่อวันที่ (Issue Date):</label>
            <input type="date" value="" id="isd" name="isd">

          </div>
          <div class="form-group">
            <label for="">** หมดอายุวัน (Expiry Date):</label>
            <input type="date" value="" id="exd" name="exd">
          </div>
          <div class="form-group">
            <label for="">** เชื้อชาติ (Race) :</label>
          ...
          <div class="form-group">
            <label for="">** สัญชาติ (Nationality) :</label>
          ...
          <div class="form-group">
            <label for="">** ศาสนา (Religion) :</label>
          ...
          <div class="form-group">
            <label for="">** วัน เดือน ปีเกิด (Date of Birth) :</label>
            <input type="date" value="" id="dob" name="dob">
          </div>
          <div class="form-group">
            <label for="">** สถานที่เกิด (Place of Birth) :</label>
            <input type="text" name="pob" id="pob" placeholder=" โปรดระบุ " required>
          </div>
          <div class="form-group">
            <label for="">** อายุ (Age) : </label>
            <input type="number" name="age" id="age" placeholder=" โปรดระบุ " min="19" max="30" value="22" required> ปี
          </div>
          <div class="form-group">
            <label for="">** เพศ (Sex) :</label>
          ...
          <div class="form-group">
            <label for="">** ส่วนสูง (Height) :</label>
            <input type="text" name="hight" id="hight" placeholder=" โปรดระบุ " pattern="[0-9]{1,}" required>เซนติเมตร
          </div>
          <div class="form-group">
            <label for="">** น้ำหนัก (Weight) :</label>
            <input type="text" name="weight" id="weight" placeholder=" โปรดระบุ " pattern="[0-9]{1,}" required> กิโลกรัม
          </div>
          <div class="form-group">
            <label for="">** โรคประจำตัวระบุ (Chronicle Disease : Specify) :</label>
            <input type="text" name="cds" id="cds" placeholder=" โปรดระบุ หากไม่มีใส่ '-' " required>
          </div>
          <div class="form-group">
            <label for="">** ที่อยู่ปัจจุบัน (Address) :</label>
          ...
          <div class="form-group">
            <label for="">** จดหมายอิเล็กทรอนิกส์ (E-mail) :</label>
          ...
          <!-- Page2 -->
          <div class="form-group">
            <h2>*** บุคคลที่ติดต่อได้ในกรณีฉุกเฉิน (Emergency Case Contact to) </h2>
          </div>
          <div class="form-group">
            <label for="">คำนำหน้าชื่อ (Title Name)</label>
          ...
          <div class="form-group">
            <label>** ชื่อ (First Name) สกุล (Last Name) :</label>
            <input type="text" name="contact" placeholder="เช่น นาย สมมาตร" required>
          </div>

          <div class="form-group">
            <label for="">** ความเกี่ยวข้อง (Relation) :</label>
          ...
          <div class="form-group">
            <label for="">** สถานที่ทำงาน (Place of Work)</label>
          ...
          <div class="form-group">
            <h2>** ข้อมูลครอบครัว (Family Details)</h2>

          </div>
          <div class="form-group">
            <label for="">** บิดา</label>
          ...
          <div class="form-group">
            ...
            <input type="text" name="pr_address" id="pr_address" placeholder=" โปรดระบุ " style="width:500px;" required>
          </div>
          <div class="form-group">
            <label for="">โทรศัพท์ (Telephone No.) :</label>
          ...
          <div class="form-group">
            <label for="">** จำนวนพี่น้อง (No. of Relatives) : คน</label>
            <input type="text" name="allbro" id="allbro" placeholder=" โปรดระบุ " required>
          </div>
          <div class="form-group">
            <label for="">** เป็นบุตรคนที่ (You are the):</label>
                      ...
                      <div class="row">
                        ...
                        <div class="box-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="std_name" id="std_name" placeholder=" โปรดระบุ " required> นักศึกษา
                          </div>
