...
{   
    ...
    function Licesen($title_pr,$pr_fullname,$pr_position)
    {
        $this->SetXY(112,185);
        ...
        $this->SetXY(75,215);
        $this->Write( 1  , iconv( 'UTF-8','cp874' ,  "$pr_position" )  );
        $this->SetXY(90,220);
        $this->Write( 1  , iconv( 'UTF-8','cp874' , 'รักษาการแทน อธิการบดีมหาวิทยาลัยราชภัฏบุรีรัมย์' )  );
...
$pdf->Licesen($title_pr,$pr_fullname,$pr_position);
$pdf->Foot();
