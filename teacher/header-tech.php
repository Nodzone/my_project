...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
    <div class="sidebar-brand-text mx-3">Teacher - Coop</div>
  </a>
  ...
  <li class="nav-item active">
    ...
    <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="stdlist.php">รายชื่อนักศึกษานิเทศ</a>
        <a class="collapse-item" href="upload_file.php">นำเข้าเอกสาร</a>
        <a class="collapse-item" href="youfile.php">เอกสารของฉัน</a>
        <!--a class="collapse-item" href="forgot-password.html">Forgot Password</a-->
        <div class="collapse-divider"></div>
        <h6 class="collapse-header">เอกสาร</h6>
        <a class="collapse-item" href="bru_co4.php">แบบแจ้งรายชื่ออาจารย์นิเทศ</a>
        <a class="collapse-item" href="bru_co7.php">แบบแจ้งกำหนดการนิเทศ<br>งานนักศึกษาสหกิจศึกษา</a>
        <a class="collapse-item" href="bru_co12.php">แบบบันทึกการนิเทศ <br>งานสหกิจศึกษา</a>
        <a class="collapse-item" href="sysytemcomment.php">แบบประเมินความพึงพอใจ <br>สหกิจศึกษา</a>
        <h6 class="collapse-header">งานสหกิจ</h6>
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              เฉพาะ Teacher เท่านั้นทีสามารถใช้หน้านี้ได้
            </div>
      ...
      <?php 
            ...
            $user_username =  !empty($user["user_username"]) ? $user["user_username"] : ''; 
            $user_password =  !empty($user["user_password"]) ? $user["user_password"] : ''; 
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
          ...
          <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
            <a class="dropdown-item" href="teacher-infor.php">
              <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
              โปรไฟล์
            </a>
            <a class="dropdown-item" href="editinfor.php">
