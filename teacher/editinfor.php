    ...
    <div class="container-fluid">
      ...
      <div>
        <form role="form" action="../controller/editprofile_controller.php" method="post">
          <input type="hidden" name="user_grade" id="user_grade" value="ไม่ระบุ">
          <input type="hidden" name="user_supervisor_status" id="user_supervisor_status" value="9">
          <input type="hidden" name="user_std_id" value="xxxxx">
          <div class="row">
            <div class="col-2">
              <label id="red">คำนำหน้าชื่อ</label>
              <select class="form-control" name="user_title" data-required="กรุณาเลือกคำนำหน้า" style="width:150px;">
                <option>-- โปรดเลือก --</option>
                <option value="อาจารย์">อาจารย์</option>
                <option value="ศาสตราจารย์">ศาสตราจารย์</option>
                <option value="ผ.ศ.">ผู้ช่วยศาสตราจารย์</option>
            ...
            <div class="col-auto">
              <label id="red"> เบอร์ติดต่อ</label>
          ...
          <div class="row">
            ...
            <div class="col-auto">
              <label>Password</label><input type="password" class="form-control" data-required="กรอกรหัสผ่าน"
                name="user_password" style="width:250px;" placeholder="รหัสผ่าน" value="<?echo $user_password;?>"
                disabled />
            </div>

            <div class="col-auto">

              <input type="hidden" class="form-control" data-required="กรอกรหัสผ่าน" name="user_std_id"
                value="<?echo $user_std_id;?>" style="width:250px;" placeholder="" disabled />
            </div>
          </div>
          <br>
          <div class="row">
            <div class="col-auto">
              <label for="exampleFormControlSelect1" id="red"> คณะ</label>
            ...
            <div class="col-auto">
              <label for="exampleFormControlSelect1" id="red"> สาขาวิชา</label>
            ...
            <div class="col-auto">
              ...
              <input type="hidden" id="user_grade" name="user_grade">
            </div>

          </div> <br>
          <div class="row">
            <div class="col-auto">
              <label id="red">ตำแหน่ง / อาชีพ</label>
            ...
            <div class="col-auto">
              ...
              <select class="form-control" name="user_coop_intership_name" id="user_coop_intership_name"
                data-required="กรุณาเลือกคำนำหน้า" style="width:200px;" disabled>
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <input class="form-control" type="text" name="ีuser_moreinfor" style="width:500px;" placeholder="" />
            </div>
          </div>
