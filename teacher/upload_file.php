                ...
                <div>
                    ...
                    <div class="form-group">
                        <select class="form-control" name="file_type" id="file_type"  style="width:500px;">
                            <option value="BRU_CO4">แบบแจ้งรายชื่ออาจารย์นิเทศ - BRU_CO4</option> 
                            <option value="BRU_CO7">แบบแจ้งกำหนดการนิเทศงานนักศึกษาสหกิจศึกษา - BRU_CO7</option>
                            <option value="BRU_CO12">แบบบันทึกงานนิเทศสหกิจศึกษา - BRU_CO12</option>
                        </select>
                    </div>
                </div>
