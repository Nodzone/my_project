                ...
                <div>
                    ...
                    <div class="form-group">
                        <select class="form-control" name="file_type" id="file_type"  style="width:500px;">
                            ...
                            <option value="6">หนังสือสัญญาการเข้ารับการฝึกปฏิบัติงานของนักศึกษา- BRU_CO6</option> 
                            <option value="8">แบบแจ้งรายละเอียดระหว่างการปฏิบัติงานสหกิจศึกษา- BRU_CO8</option>
                            <option value="10">แบบแจ้งแผนปฏิบัติงานสหกิจศึกษา - BRU_CO10</option>
                            <option value="11">แบบแจ้งโครงร่างรายงานการปฏิบัติงาน - BRU_CO11</option> 
                            <option value="15">แบบแจ้งยืนยันส่งรายงานการปฏิบัติงาน - BRU_CO15</option>
                            <option value="16">แบบแจ้งรายละเอียดเกี่ยวกับการปฏิบัติงานสหกิจศึกษา - BRU_CO62</option>
                        </select>
                    </div>
                </div>              
