  ...
  <div id="wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">แบบแจ้งรายละเอียดเกี่ยวกับการปฏิบัติงานสหกิจศึกษา</h1>
      </div>
      <div>

        <Form name="BRU_CO8" action="../FPDF/bru_co16.php" method="post" align="left">
          ...
          <div class="form-group" align="left">
            ...
            <label for="">งานสหกิจศึกษาฯ ต้องการข้อมูลเกี่ยวกับการปฏิบัติงานของนักศึกษาเพื่อจัดทำเป็นหนังสือ
              สรุปผลการปฏิบัติงาน ประจำภาคการศึกษา โปรดกรอกข้อความด้วยตัวอักษรบรรจง<br> และนำส่งงาน
              สหกิจศึกษาทันทีที่กลับจากสถานปฏิบัติงานถึงมหาวิทยาลัย เรียบร้อยแล้ว
            </label> <br>
          ...
          <div class="form-group">
            <label>ตำแหน่ง</label>
            <input type="text" name="position" id="position" placeholder="หากไม่มีให้ใส่ - "></input>
          </div>
          <div class="form-group">
            <label>รายละเอียดเนื้องานที่ปฏิบัติ : (พอสังเขป)</label> <br>
            <textarea type="text" name="jobdescription" id="jobdescription" placeholder="รายละเอียด - " rows="4"
              cols="100"></textarea>
          </div>

          <div class="form-group">
            <label>หัวข้อรายงาน (Report Topic)</label>
            <div class="form-group">
              <label>(ภาษาไทย)</label>
              <input type="text" name="thai" id="thai" placeholder="หากไม่มีให้ใส่ - "></input>
            </div>
            <div class="form-group">
              <label>(ภาษาอังกฤษ)</label>
              <input type="text" name="english" id="english" placeholder="หากไม่มีให้ใส่ - "></input>
            </div>
            <?php }} ?>
            <div class="form-group">
              <br>
