...
<div class="sidebar-brand-text mx-3">Student - Coop</div>
      </a>
      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          ...
          <h6 class="collapse-header">ห้วข้อหลัก</h6>
          <a class="collapse-item" href="std-info.php">ข้อมูลส่วนตัว</a>
          ...
          <a class="collapse-item" href="bru_co8.php">แบบแจ้งรายละเอียดระหว่าง<br>การปฏิบัติงานสหกิจศึกษา</a>
          <a class="collapse-item" href="bru_co10.php">แบบแจ้งแผนปฏิบัติ<br>งานสหกิจศึกษา</a>
          <a class="collapse-item" href="bru_co11.php">แบบแจ้งโครงร่าง<br>รายงานการปฏิบัติงาน</a>
          <a class="collapse-item" href="bru_co16.php">แบบแจ้งรายละเอียดเกี่ยวกับ<br>การปฏิบัติงานสหกิจศึกษา</a>
          <a class="collapse-item" href="bru_co15.php">แบบแจ้งยืนยันส่ง<br>รายงานการปฏิบัติงาน</a>
          <a class="collapse-item" href="dairy.php">บันทึกงานประจำวัน</a>
          <a class="collapse-item" href="report.php">ประเมินระบบ</a>
          </div>
        </div>
      </li>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  เฉพาะ Student เท่านั้นทีสามารถใช้หน้านี้ได้
                </div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="std_editinfor.php">
