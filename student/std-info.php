...
$user = new Edit_Profile();
$find_profile_user = $user->find_profile_user();
$partner = new  Manage_Partnet ();
$find_student_part = $partner->find_student_part();

//  echo "<pre>"; print_r($find_profile_user); echo "</pre>";
      ...
      <?php
                    if($find_profile_user){
                      foreach ($find_profile_user as $val){
                        ...
                        $user_submajor = !empty($val['user_major'])? $val['user_major'] : '';
                        $user_major = !empty($val['user_faculty'])? $val['user_faculty'] : '';
