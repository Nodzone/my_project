...
$show = new News_Show($_GET['news']);
$find_news_coop = $show->find_News();
//  echo "<pre>"; print_r($find_news_coop); echo "</pre>"; 
...
<body id="page-top" style="background-color:#FFFCFF;">
  ...
  <section>
    <div class="container" align="center">
      ...
      <H4><?php echo $news_detail; ?></H4>
      <H6><?php echo "คุณ " . $news_create_by; ?></H6>
      <?php } } ?>
    </div>
    <div>
  ...
  <div class="row">
    <div class="col-auto">
      <div class="line-it-button" data-lang="eng" data-type="share-a" data-ver="3"
        data-url="https://www.bru.ac.th/page_news.php?news=<?php echo $news_id;?>" data-color="default"
    ...
    <div class="col-auto">
      <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button"
        data-url="https://www.bru.ac.th/page_news.php?news=<?php echo $news_id;?>" data-size="large" data-lang="en"
        data-show-count="false">Tweet</a>
      <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
    </div>
    <div class="col-auto">
      <div id="fb-root">
        <div class="fb-share-button" data-href="https://www.bru.ac.th/page_news.php?news=<?php echo $news_id;?>"
