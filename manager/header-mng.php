...
<div class="sidebar-brand-text mx-3">Manager - Coop</div>
      </a>
      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="std-want.php">เอกสารรออนุมัติ</a>
          <a class="collapse-item" href="std-done.php">เอกสารที่อนุมัติแล้ว</a>  
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  เฉพาะ ผู้บริหาร (Manager) เท่านั้นทีสามารถใช้หน้านี้ได้
                </div>
