            ...
            <div>
              ...
              <tbody>
                <?php $i=0;
                  if($find_user_file){
                    foreach ($find_user_file as $val){
                      ...
                      $file_update_by = !empty($val['file_update_by'])? $val['file_update_by'] : '';
                      $file_update_by = !empty($val['file_update_by'])? $val['file_update_by'] : '';
                      $i=$i+1;
                ...
                <tr class="table-success">
                      ...
                      <td><?php echo $file_update_by;?></td>
                      <!-- <td><?php echo $file_status;?></td> -->
                      <td><button onclick="window.open('<?php echo $file_local;?>', '_blank')" class="btn btn-info btn-xs view_data">ดูเอกสาร</button></td>
